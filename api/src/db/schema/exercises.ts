import { pgEnum, pgTable, real, text, unique } from "drizzle-orm/pg-core";
...
export const exerciseMuscles = pgTable(
  "exercise_muscles",
  {
    ...
    coefficient: real("coefficient").notNull(), // 1.0 primary, 0.4 secondary
  },
  (t) => [unique().on(t.exerciseId, t.muscleGroupId)]
);
